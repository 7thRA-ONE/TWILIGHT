        ...
        function (e) {
          var t = e.displayName || e.name || "Component",
            r = (function (t) {
              ...
              return (
                (a.asyncScriptLoaderGetScriptLoaderID = function () {
                  return (
                    this.__scriptLoaderID ||
                      (this.__scriptLoaderID = "async-script-loader-" + l++),
                    this.__scriptLoaderID
                  );
                }),
                ...
                (a.componentDidMount = function () {
                  ...
                  for (var d in ((p.src = t), (p.async = !0), m.attributes))
                    p.setAttribute(d, m.attributes[d]);
                  a && (p.id = a);
                  var u = function (e) {
                    if (f[t]) {
                      var r = f[t].observers;
            ...
            o = (0, n.forwardRef)(function (e, t) {
              return (0, n.createElement)(r, u({}, e, { forwardedRef: t }));
            });
          return (
            (o.displayName = "AsyncScriptLoader(" + t + ")"),
            (o.propTypes = { asyncScriptOnLoad: i().func }),
            d()(o, e)
          );
        })(s),
        v = g;
