      ...
      var S = function (e) {
          ...
          Pe = function (e) {
            if (ne && me.current) {
              ...
              if (we.current.length > 1)
                for (
                  var n = we.current[0],
                    r = we.current[we.current.length - 1],
                    o = r.time - n.time,
              ...
              if (ne) {
                for (
                  var t = null === se.current,
                    ...
                    r = ie + n,
                    o = Date.now();
                  we.current.length > 0 && !(o - we.current[0].time <= 100);

                )
                  we.current.shift();
                we.current.push({ pos: r, time: o }),
                  t || ae(r),
                  (se.current = e);
              }
            },
        ...
        return o.default.createElement(
          ...
          o.default.createElement(a.default, {
            ...
            message: _({ currentSlide: J, count: K }),
          }),
          (0, l.default)(t, K, J, he, Se, Oe, q),
